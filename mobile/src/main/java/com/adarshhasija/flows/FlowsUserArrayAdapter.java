...
/**
 * Created by adarshhasija on 5/23/15.
 */
public class FlowsUserArrayAdapter extends ArrayAdapter<ParseObject> {

    private static String LOG_TAG = "FlowsUserArrayAdapter";
    ...
    public FlowsUserArrayAdapter(Context context, int resource, List<ParseObject> objects) {
