...
/**
 * Created by adarshhasija on 5/22/15.
 */
public class FlowItemsAdapter extends ArrayAdapter<ParseObject> {
    ...
    public FlowItemsAdapter(Context context, int resource, List<ParseObject> objects) {
